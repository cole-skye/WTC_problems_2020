...
HAL: What must I do next?  > HAL turned right.
 > HAL now at position (0,0).
HAL: What must I do next? HAL: Shutting down..""", output)
    def test_step8_right_fwd10_off(self):
        with captured_io(StringIO('HAL\nright\nforward 10\noff\n')) as (out):
            robot.robot_start()
        output = out.getvalue().strip()
        self.assertEqual("""What do you want to name your robot? HAL: Hello kiddo!
...
HAL: What must I do next? HAL: Shutting down..""", output)
    def test_step8_right_back10_off(self):
        with captured_io(StringIO('HAL\nright\nback 10\noff\n')) as (out):
            robot.robot_start()
        output = out.getvalue().strip()
        self.assertEqual("""What do you want to name your robot? HAL: Hello kiddo!
...
HAL: What must I do next?  > HAL moved back by 10 steps.
 > HAL now at position (-10,0).
HAL: What must I do next? HAL: Shutting down..""", output)
    def test_step8_right_fwd10_right_fwd5_off(self):
        with captured_io(StringIO('HAL\nright\nforward 10\nright\nforward 5\noff\n')) as (out):
            robot.robot_start()
        output = out.getvalue().strip()
        self.assertEqual("""What do you want to name your robot? HAL: Hello kiddo!
...
HAL: What must I do next?  > HAL moved forward by 10 steps.
 > HAL now at position (-10,0).
HAL: What must I do next? HAL: Shutting down..""", output)
    def test_step9_left_back10_off(self):
        with captured_io(StringIO('HAL\nleft\nback 10\noff\n')) as (out):
            robot.robot_start()
        output = out.getvalue().strip()
        self.assertEqual("""What do you want to name your robot? HAL: Hello kiddo!
...
HAL: What must I do next?  > HAL moved back by 10 steps.
 > HAL now at position (10,0).
HAL: What must I do next? HAL: Shutting down..""", output)
    def test_step9_left_fwd10_left_fwd5_off(self):
        with captured_io(StringIO('HAL\nleft\nforward 10\nleft\nforward 5\noff\n')) as (out):
            robot.robot_start()
        output = out.getvalue().strip()
        self.assertEqual("""What do you want to name your robot? HAL: Hello kiddo!
...
HAL: What must I do next?  > HAL moved forward by 5 steps.
 > HAL now at position (-10,-5).
HAL: What must I do next? HAL: Shutting down..""", output)
    def test_step10_fwd201_fwd10_then_off(self):
        with captured_io(StringIO('HAL\nforward 201\nforward 10\noff\n')) as (out):
            robot.robot_start()
        output = out.getvalue().strip()
        self.assertEqual("""What do you want to name your robot? HAL: Hello kiddo!
