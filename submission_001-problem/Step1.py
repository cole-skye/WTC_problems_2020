...
student_list = [( "1.", random.choice(names), "-" , random.choice(course) , "-" , random.choice(problem) , Status[2]),
                ( "2.", random.choice(names), "-" , random.choice(course) , "-" , random.choice(problem) , Status[1]),
                ( "3.", random.choice(names), "-" , random.choice(course) , "-" , random.choice(problem) , Status[0])]
